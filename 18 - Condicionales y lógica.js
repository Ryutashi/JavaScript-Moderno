...
if (year >= 2000 && year <= 2030) {
    console.log("Estamos la era moderna"); // Estamos la era moderna

}else if (year > 2030) {
    console.log("Estamos en era postmoderna");
...
if (year == 2007 || year == 2017 || year == 2027 || year == 2037) {
    ...
    // En este caso en falso, por que el año es "2028" y no termina en 7.
